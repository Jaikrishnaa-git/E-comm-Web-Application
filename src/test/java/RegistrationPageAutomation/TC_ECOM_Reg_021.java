...
public class TC_ECOM_Reg_021 extends BaseTest {

    @Test
    public void verifyPasswordTextboxWithValidPassword() {

        // Create Extent Report entry
        test = extent.createTest("TC_ECOM_Reg_021 - Verify and Validate Password Textbox with Valid Password");
        ...
        try {
            ...
            String uniqueEmail = "vinodkumar" + System.currentTimeMillis() + "@gmail.com";
            ...
            // Step 6: Fill all mandatory fields including valid password
            driver.findElement(By.id("id_gender1")).click();

            WebElement passwordField = driver.findElement(By.id("password"));
            passwordField.clear();
            passwordField.sendKeys("Team@A8");
            test.info("Entered valid password: Team@A8");
            ...
            test.pass("Account created successfully. Password functionality is working as expected.");
