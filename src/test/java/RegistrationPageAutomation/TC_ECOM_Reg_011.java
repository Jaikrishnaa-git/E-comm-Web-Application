...
public class TC_ECOM_Reg_011 extends BaseTest{
  ...
  public void verifySignup(String userName, String mailId) throws InterruptedException, IOException {
      ...
      if (!currentURL.equals(expectedURL)) {
          test.fail("Unexpectedly navigated to another page despite invalid email.")
              .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "Unexpected_Navigation_TC_ECOM_Reg_011"));
      } else {
  ...
  public Object[][] logindata() {
      try {
          ...
          Object[][] data = ExcelUtilities.getdata(projectpath + "\\src\\test\\resources\\Testdata\\data.xlsx", "no name valid email");
