...
public class TC_ECOM_Reg_006 extends BaseTest{
  ...
  public void verifySignup(String userName, String mailId) throws InterruptedException, IOException {
      ...
      if (!currentURL.equals(expectedURL)) {
          test.fail("Unexpectedly navigated to another page despite empty email.")
              .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "Unexpected_Navigation_TC_ECOM_Reg_006"));
      } else {
          test.pass("Stayed on login page as expected when email was empty.");
      }
  }
  ...
  public Object[][] logindata() {
      try {
          ...
          Object[][] data = ExcelUtilities.getdata(projectpath + "\\src\\test\\resources\\Testdata\\data.xlsx", "valid name no email");
