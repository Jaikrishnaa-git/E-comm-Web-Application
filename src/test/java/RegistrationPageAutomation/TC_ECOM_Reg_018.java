...
public class TC_ECOM_Reg_018 extends BaseTest {

    @Test
    public void verifyNameTextboxWithNoName() throws InterruptedException {

        // Create Extent Report entry
        test = extent.createTest("TC_ECOM_Reg_018 - Verify Name Text Box with No Name");
        ...
        String uniqueEmail = "Jaikrishna24" + System.currentTimeMillis() + "@gmail.com";
        ...
        // Step 6: Clear Name textbox and click Create Account
        ...
        test.info("Clicked on Create Account button without entering name.");

        // Step 7: Verify browser validation message
        String validationMessage = nameTextbox.getAttribute("validationMessage");
        test.info("Validation Message: " + validationMessage);
        Assert.assertEquals(validationMessage, "Please fill out this field.",
                "Validation message mismatch!");
        test.pass("PASS - Correct validation message displayed: " + validationMessage);
    }
}
