...
public class TC_ECOM_Reg_010 extends BaseTest{
  ...
  public void verifySignup(String userName, String mailId) throws InterruptedException, IOException {
      ...
      if (!currentURL.equals(expectedURL)) {
          test.fail("Unexpectedly navigated to another page despite invalid email.")
              .addScreenCaptureFromPath(ScreenshotUtilities.capturescreen(driver, "Unexpected_Navigation_TC_ECOM_Reg_010"));
      } else {
  ...
  public Object[][] logindata() {
      try {
          ...
          Object[][] data = ExcelUtilities.getdata(projectpath + "\\src\\test\\resources\\Testdata\\data.xlsx", "invalid name invalid email");
