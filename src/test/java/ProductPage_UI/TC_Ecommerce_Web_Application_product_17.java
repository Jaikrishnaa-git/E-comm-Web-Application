...
public class TC_Ecommerce_Web_Application_product_17 extends BaseTest {

    @Test
    public void verifyBrandMadameButtonInProductPage() throws IOException {

        // Start Extent Report Test
        test = extent.createTest("TC_Ecommerce_Web_Application_product_17 - Verify MADAME Brand Button in Product Page");
