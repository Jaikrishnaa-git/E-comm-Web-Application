...
public class TC_Ecommerce_Web_Application_product_27 extends BaseTest {

    @Test
    public void verifyUpArrowInScrollBar() throws IOException {

        // Start Extent Report Test
        test = extent.createTest("TC_Ecommerce_Web_Application_product_27 - Verify Up Arrow in Scroll Bar in Product Page");
