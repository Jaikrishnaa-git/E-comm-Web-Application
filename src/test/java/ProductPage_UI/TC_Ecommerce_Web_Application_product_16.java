...
public class TC_Ecommerce_Web_Application_product_16 extends BaseTest {

    @Test
    public void verifyBrandHandMButtonInProductPage() throws IOException {

        // Start Extent Report Test
        test = extent.createTest("TC_Ecommerce_Web_Application_product_16 - Verify H&M Brand Button in Product Page");
