...
public class TC_Ecommerce_Web_Application_product_18 extends BaseTest {

    @Test
    public void verifyBrandMastAndHarbourButtonInProductPage() throws IOException {

        // Start Extent Report Test
        test = extent.createTest("TC_Ecommerce_Web_Application_product_18 - Verify Mast & Harbour Brand Button in Product Page");
