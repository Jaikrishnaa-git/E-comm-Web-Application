...
public class TC_Ecommerce_Web_Application_product_21 extends BaseTest {

    @Test
    public void verifyBrandAllenSollyJuniorButtonInProductPage() throws IOException {

        // Start Extent Report Test
        test = extent.createTest("TC_Ecommerce_Web_Application_product_21 - Verify ALLEN SOLLY JUNIOR Brand Button in Product Page");
