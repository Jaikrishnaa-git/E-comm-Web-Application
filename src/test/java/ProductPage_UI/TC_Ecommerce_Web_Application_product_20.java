...
public class TC_Ecommerce_Web_Application_product_20 extends BaseTest {

    @Test
    public void verifyBrandKookieKidsButtonInProductPage() throws IOException {

        // Start Extent Report Test
        test = extent.createTest("TC_Ecommerce_Web_Application_product_20 - Verify KOOKIE KIDS Brand Button in Product Page");
